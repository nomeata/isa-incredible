...
All this happens with regard to an abstract set of formulas (Theory \isa{Abstract_Formula})and an abstract set of logic rules
(Theory \isa{Abstract_Rules}) and can thus be instantiated with various logics.
